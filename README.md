...
This should be the simplest of the tabs discussed under the layouts section. It should just be a timeline of awards I have won. You can find information about these between both my resume and my CV. Some awards may be associated with projects, roles, or publications. Hovering/clicking on awards should show a popover that lets you navigate to these relevant projects, roles, or publications.
